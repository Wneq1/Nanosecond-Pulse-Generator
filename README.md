...
During the implementation, the author drew inspiration from the concept presented in the article "5ns pulse generator" from polprog.net, adapting the design to components readily available on the Polish market.
